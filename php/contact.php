 ...
 *
 * À configurer :
 *   - DESTINATAIRE : adresse email de réception (ex. studyalready8@gmail.com)
...
if (!$envoyé) {
    reponse(500, "Impossible d'envoyer le message. Merci d'écrire directement à studyalready8@gmail.com.");
}
